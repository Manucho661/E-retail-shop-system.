...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    <div class="navbar-header"><!-- navbar-header begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand" style="font-size:20px;">Admin Area</a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="index.php?reports"><!-- a href begin -->
                    <i class="fa fa-fw fa-money"></i> reports
                </a><!-- a href finish -->
            </li><!-- li finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_paymentz"><!-- a href begin -->
                    <i class="fa fa-fw fa-money"></i> View reports
                </a><!-- a href finish -->
            </li><!-- li finish -->
